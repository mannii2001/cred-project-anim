...
const AppRating = () => {
    const getIosPrefix = ()=>{
        return <img src="https://web-images.credcdn.in/_next/assets/images/home-page/apple-store-logo.png" alt="" className="app-rating-action"/>
    }
    const getAndriodPrefix = ()=>{
        return <img src="https://web-images.credcdn.in/_next/assets/images/home-page/play-store-logo.png" alt="" className="app-rating-action"/>
    }
